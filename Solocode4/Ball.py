...
class Ball():
    ...
    def __init__(self, window, windowWidth, windowHeight):
        ...
        # remember the window, so we can draw later
        self.window = window
        ...
        # Choose a random speed between -7 and 7, but not zero
    ...
    def update(self):
        ...
        # Check for hitting a wall. If so, change direction
        ...
        # Update y position using sine wave motion
    ...
    def draw(self):
        ...
        # draw the ball image at current position
